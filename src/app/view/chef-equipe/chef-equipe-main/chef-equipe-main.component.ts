...
@Component({
  selector: 'app-chef-equipe-main',
  templateUrl: './chef-equipe-main.component.html',
  styleUrls: ['./chef-equipe-main.component.scss']
})
export class ChefEquipeMainComponent implements OnInit {

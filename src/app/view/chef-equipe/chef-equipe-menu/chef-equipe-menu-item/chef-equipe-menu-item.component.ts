...
@Component({
  selector: 'app-chef-equipe-menu-item',
  template: `
        <ng-container>
...
export class ChefEquipeMenuItemComponent implements OnInit {
  ...
  key: string;
  constructor(public appMain: ChefEquipeMainComponent, public router: Router, private cd: ChangeDetectorRef, private menuService: MenuService) {

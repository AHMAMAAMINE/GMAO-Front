    ...
    ngOnInit() {
        this.model = [
            ...
            },
            {
                ...
                items: [
                    {label: 'intervention', icon: 'pi pi-fw pi-pencil', routerLink: ['/view/commande']},
                    {label: 'equipe', icon: 'pi pi-users', routerLink: ['view/equipes']},
                    {label: 'OperationStock', icon: 'pi pi-users', routerLink: ['view/operation']},
